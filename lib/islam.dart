...
class HalamanIslam extends StatefulWidget {
  const HalamanIslam({super.key});

  @override
  State<HalamanIslam> createState() => _HalamanIslamState();
}

class _HalamanIslamState extends State<HalamanIslam> {
